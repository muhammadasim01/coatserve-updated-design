...
const Header = ({ModuleName,HeaderData,getdocumenttype,setgetserviceseries,setgetdocnumfromcomponent,getdocumentname,getdocentryforreport}) =>  {
...
const clicLeft=async()=>{
  ...
  const api = `${LINKS.api}/GetApi`
  let cookie = await localStorage.getItem('cookie')
  let SAPapi = `PurchaseRequets?$select=DocNum eq '${HeaderData&&HeaderData.DocNum - 1}'`
  await axios
    .post(api, {
      api: SAPapi,
      cookie: cookie
    ...
    <Navbar bg="light" expand="lg">
      ...
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="mr-auto">
          ...
          <div className="mb-2">
              ...
              <DropdownButton
                ...
                title={`  Setup  `}
              >
              <Dropdown.Item disabled href="#">General</Dropdown.Item>    
              <div className="mb-2">
              <DropdownButton
                size="lg"
                as={ButtonGroup}
                ...
                title={`  Financials  `}
              >
              <Dropdown.Item disabled href="#">Branches</Dropdown.Item> 
                <Dropdown.Item disabled href="#">Currencies</Dropdown.Item> 
              ...
              <DropdownButton
                ...
                title={`  Tax  `}
              >
              <Dropdown.Item  href="TaxGroup">Tax Groups</Dropdown.Item> 
                <Dropdown.Item disabled href="#">Tax Code Determination</Dropdown.Item> 
                <Dropdown.Item disabled href="#">Withholding Tax</Dropdown.Item> 
                <Dropdown.Item disabled href="#">Tax Declaration Boxes</Dropdown.Item> 
              </DropdownButton>
            </div> 
              </DropdownButton>
            </div> 
              ...
              >
                ...
                <Dropdown.Item disabled href="#">House Bank Accounts</Dropdown.Item> 
                <Dropdown.Item disabled href="#">Credit Cards</Dropdown.Item> 
                <Dropdown.Item disabled href="#">Credit Card Payment</Dropdown.Item> 
              </DropdownButton>
            </div> 
            <div className="mb-2">
              <DropdownButton
                ...
                title={`  Inventory  `}
              >
                <Dropdown.Item disabled  href="ItemGroups">Item Groups</Dropdown.Item> 
                <Dropdown.Item disabled href="#">Warehouses</Dropdown.Item> 
            ...
            <div className="mb-2">
              <DropdownButton
                ...
                title={`  Financials  `}
              >
              {/* <Dropdown.Item href="ChartOfAccounts">Chart Of Accounts</Dropdown.Item>  */}
                <Dropdown.Item href="JournalEntries">Journal Entry</Dropdown.Item>  
                <Dropdown.Item onClick={e=>{setShow1(true)}}>Trial Balance Report</Dropdown.Item>  
                <Dropdown.Item href="AccountBalanceReport">Account Balance Report</Dropdown.Item>  
              </DropdownButton>
            </div>
            <div className="mb-2">
              <DropdownButton
            ...
            <div className="mb-2">
              ...
              >
              <Dropdown.Item href="#">Business Partner Master Data</Dropdown.Item>  
            ...
            <div className="mb-2">
              ...
              >
                ...
                <Dropdown.Item href="IncomingPayments">Incoming Payment</Dropdown.Item>  
                <Dropdown.Item href="OutgoingPayments">Outgoing Payment</Dropdown.Item>
              </DropdownButton>
            </div>
            <div className="mb-2">
              <DropdownButton
                ...
                title={` Inventory  `}
              >
                <Dropdown.Item href="ItemsMasterData">Item Master Data</Dropdown.Item>
                <Dropdown.Item href="InventoryReports">Inventory Reports</Dropdown.Item>
                <Dropdown.Item disabled href="#">Bar Codes</Dropdown.Item>
                <Dropdown.Item disabled href="#">Document Printing</Dropdown.Item>
                <Dropdown.Item disabled href="#">Bin Locations</Dropdown.Item>
                <div className="mb-2">
              <DropdownButton
                size="lg"
                as={ButtonGroup}
              ...
              >
                ...
                <Dropdown.Item disabled href="#">Price Lists</Dropdown.Item>
                <Dropdown.Item disabled href="#">Pick And Pack</Dropdown.Item>
                <Dropdown.Item disabled href="#">Inventory Reports</Dropdown.Item>
              </DropdownButton>
            </div>
            <div className="mb-2">
              <DropdownButton
            ...
            <div className="mb-2">
              <DropdownButton
                ...
                title={`  Production  `}
              >
                <Dropdown.Item href="BillOfMaterials">Bill Of Materials</Dropdown.Item>  
                <Dropdown.Item href="ProductionOrder">Production Order</Dropdown.Item>
                <Dropdown.Item href="ReceiptFromProduction">Receipt From Production</Dropdown.Item>  
                <Dropdown.Item href="IssueForProduction">Issue For Production</Dropdown.Item>  
              </DropdownButton>
            </div>  
            <div className="mb-2">
              <DropdownButton
        ...
        <Form inline>
          ...
          <Button disabled variant="outline-secondary" href="PurchaseQuotation">
            Search
          </Button>
    ...
    <Modal show={show1} onHide={handleClose2}>
        ...
        <Modal.Footer>
          ...
          <Button variant='primary' onClick={handleClose2}>
            ...
            <a style={{color:'black'}} class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Preview" rel="" onClick={e=>{clicPreview()}}   type="application/pdf"  ><FindInPageSharpIcon style={{marginTop:'5px',margin:'5px'}} /> 
             </a>
            <a style={{color:'black'}}  class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Print"  rel="" href="#" onClick={()=>{clicPrint()}}><PrintTwoToneIcon style={{marginTop:'5px',margin:'5px'}}/> </a>
            <a style={{color:'black'}}  class="" data-bs-toggle="tooltip" data-bs-placement="top" title="E-mail"  rel="" href="#" onClick={()=>{clicEmail()}}><EmailTwoToneIcon style={{marginTop:'5px',margin:'5px'}}/> </a>
            <a style={{color:'black'}}  class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Sms"  rel="" href="#" onClick={()=>{clicSms()}}><SmsTwoToneIcon style={{marginTop:'5px',margin:'5px'}}/> </a>
            <a style={{color:'black'}}  class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Fax"  rel="" href="#" onClick={()=>{clicFax()}}><FaFax style={{marginTop:'5px',margin:'5px'}}/> </a>
            <a style={{color:'black'}}  class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Screenlock"  rel="" href="#" onClick={()=>{clicScreenlock()}}><ScreenLockPortraitIcon style={{marginTop:'5px',margin:'5px'}}/> </a>
            <a style={{color:'black'}}  class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Add file"  rel="" href="#" onClick={()=>{clicAddfile()}}> <AiFillFileAdd style={{marginTop:'5px',margin:'5px'}}/> </a>
            <a  class="" data-bs-toggle="tooltip" data-bs-placement="top" title="PDF"  rel="" href="#" onClick={()=>{clicPDF()}}> <GrDocumentPdf style={{marginTop:'5px',margin:'5px'}}/> </a>
            <a  class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Word"  rel="" href="#" onClick={()=>{clicWord()}}> <GrDocumentWord style={{marginTop:'5px',margin:'5px'}}/> </a>
            {/* <a  class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Excel" rel="" href="#" onClick={()=>{clicExcel()}}><GrDocumentExcel   style={{marginTop:'5px',margin:'5px'}}>
           </GrDocumentExcel></a> */}
           <ReactHTMLTableToExcel
                    ...
                    // buttonText=   
                    />
            <a style={{color:'black'}}  class="" data-bs-toggle="tooltip" data-bs-placement="top" title="First Data Record" rel=""  onClick={()=>{clicPrevious()}}> <SkipPreviousIcon style={{marginTop:'5px',margin:'5px'}}/> </a>
            <a style={{color:'black'}}  class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Previous Record" rel="" href=""  onClick={()=>{clicLeft()}}><ArrowBackIosIcon style={{marginTop:'5px',fontSize:'medium', margin:'5px'}}/> </a>
            <a style={{color:'black'}}  class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Next Record" rel="" href=""  onClick={()=>{clicRight()}}><NavigateNextIcon style={{marginTop:'5px',margin:'5px'}}/> </a>
            <a style={{color:'black'}}  class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Last Data Record" rel="" href=""  onClick={()=>{clicNext()}}><SkipNextIcon style={{marginTop:'5px',margin:'5px'}}/> </a>
            <a style={{color:'black'}}  class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Filter" rel="" href="#" onClick={()=>{clicFilter()}}><RiFilterFill  style={{marginTop:'5px',margin:'5px'}}/> </a>
            <a style={{color:'black'}}  class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Journal Entry Preview" rel="" href="#" onClick={()=>{TransNumber()}}><VscOpenPreview  style={{marginTop:'5px',margin:'5px'}}/> </a>
            <a style={{color:'black'}}  class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Sort" rel="" href="#" onClick={()=>{clicSort()}}><SortByAlphaIcon style={{marginTop:'5px',margin:'5px'}}/> </a>
            <a  class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Transfer Document"  rel="" href="#" onClick={()=>{clicTransferDocument()}}> <GrDocumentTransfer style={{marginTop:'5px',margin:'5px'}}/> </a>
            <a  class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Document" rel="" href="#" onClick={()=>{clicDocument()}}><GrDocument style={{marginTop:'5px',margin:'5px'}}/> </a>
            <a style={{color:'black'}}  class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Transaction" rel="" href="#" onClick={()=>{clicTransaction()}}><AiOutlineTransaction style={{marginTop:'5px',margin:'5px'}}/> </a>
            <a style={{color:'black'}}  class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" rel="" href="#" onClick={()=>{clicEdit()}}><BiEditAlt style={{marginTop:'5px',margin:'5px'}}/> </a>
            <a  class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Configure Document" rel="" href="#" onClick={()=>{clicConfigureDocument()}}><GrDocumentConfig style={{marginTop:'5px',margin:'5px'}}/> </a>
            <a style={{color:'black'}}  class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Calender" rel="" href="#" onClick={()=>{clicCalender()}}><BiCalendar style={{marginTop:'5px',margin:'5px'}}/> </a>
            <a style={{color:'black'}}  class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Person" rel="" href="#" onClick={()=>{clicPerson()}}><PersonIcon style={{marginTop:'5px',margin:'5px'}}/> </a>
            <a style={{color:'black'}}  class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Help" rel="" href="#" onClick={()=>{clicHelp()}}><HelpOutlineIcon style={{marginTop:'5px',margin:'5px'}}/> </a>
