...
const General = ({setStartDate,setStartTime,setEndDate,setEndTime,SelectedPRDocEntry,HeaderData }) =>  {
            ...
            <div style={{ width: '22rem', height: 'auto' }}>
              ...
              <input
                ...
                onChange={e => setStartDate(e.target.value)}
                 value={ SelectedPRDocEntry && SelectedPRDocEntry.StartDate  || HeaderData && HeaderData.StartDate}
              ></input>
              <input
                //value={SelectedPRDocEntry && SelectedPRDocEntry.RequesterEmail}
                type='time'
                ...
                value={ SelectedPRDocEntry && SelectedPRDocEntry.StartTime  || HeaderData && HeaderData.StartTime}
              ></input></div>
             <div style={{ width: '22rem', height: 'auto' }}>
              ...
              <input
                ...
                value={ SelectedPRDocEntry && SelectedPRDocEntry.EndDueDate  || HeaderData && HeaderData.EndDueDate}
              ></input>
              <input
                //value={SelectedPRDocEntry && SelectedPRDocEntry.RequesterEmail}
                type='time'
                ...
                value={ SelectedPRDocEntry && SelectedPRDocEntry. EndTime || HeaderData && HeaderData.EndTime}
              ></input>
              </div>
           <div style={{ width: '22rem', height: 'auto' }}>
              ...
              <input
                ...
                placeholder={ SelectedPRDocEntry && SelectedPRDocEntry.Duration  || HeaderData && HeaderData.Duration}
              ></input>
           </div>
            </DIV3>
            <DIV4></DIV4>
          ...
          <div style={{ width: '22rem', height: 'auto' }}>
            ...
            <div>
              <Select
                // value={ContactPersonDropdown.filter(
                  options={Priority}
                  placeholder={ SelectedPRDocEntry && SelectedPRDocEntry.Priority  || HeaderData && HeaderData.Priority}
                //options={ContactPersonDropdown} // Options to display in the dropdown
                // onSelect={GroupNo} // Function will trigger on select event
                // onRemove={GroupNo} Function will trigger on remove event
                displayValue='name' // Property name to display in the dropdown options
            ...
            <div>
              <Select
                // value={ContactPersonDropdown.filter(
                  ...
                  placeholder={ SelectedPRDocEntry && SelectedPRDocEntry.Location  || HeaderData && HeaderData.Location}
                //options={ContactPersonDropdown} // Options to display in the dropdown
                // onSelect={GroupNo} // Function will trigger on select event
                // onRemove={GroupNo} Function will trigger on remove event
                displayValue='name' // Property name to display in the dropdown options
