...
export default function InventoryGenEntries() {
  ...
  const [ContractTemplatesDropDown, setContractTemplatesDropDown] =
    React.useState();
  ...
  const [getInventoryCyclesDropdown, setgetInventoryCyclesDropdown] =
    React.useState();
                  ...
                  <CardGroup>
                    ...
                    <div style={{ width: "7rem", height: "auto" }}>
                      <Select
                        ...
                        onChange={(e) => {
                          getItemsList(e.value);
                          setgetseriesvalue(e.item);
                            ...
                            options={[
                              {
                                ...
                                value: "bomm_OnEveryTransaction",
                              },
                              {
                                label: "On Release Only",
                                value: "bomm_OnReleaseOnly",
                              },
                            ]}
                          />
                        </div>
                ...
                <DIV4>
                  ...
                  >
                    <CardGroup>
                      ...
                      <div
                        class="form-check form-check-inline"
                        style={{ marginTop: "0.5rem", marginRight: "15rem" }}
                      >
                        <input
                          class="form-check-input"
                          name="Active"
                          checked={getvaluechange === "Active"}
                          onClick={(e) => setgetvaluechange(e.target.name)}
                          type="radio"
                          id="inlineCheckbox1"
                          value="option1"
                        />
                      ...
                      {getvaluechange === "Active" ? (
                        <>
                          <div style={{ width: "23.5rem", height: "auto" }}>
                            <label>From</label>{" "}
                            <label style={{ marginLeft: "9rem" }}>To</label>
                            <CardGroup>
                              <br />
                              <div style={{ width: "11.5rem", height: "auto" }}>
                                <input
                      ...
                      >
                        <input
                          class="form-check-input"
                          name="Inactive"
                          checked={getvaluechange === "Inactive"}
                          onClick={(e) => setgetvaluechange(e.target.name)}
                          type="radio"
                          id="inlineCheckbox1"
                          value="option1"
                      ...
                      >
                        <input
                          class="form-check-input"
                          name="Advance"
                          checked={getvaluechange === "Advance"}
                          onClick={(e) => setgetvaluechange(e.target.name)}
                          type="radio"
                          id="inlineCheckbox1"
                          value="option1"
                  ...
                  <Container fluid>
                    ...
                    <div style={{ width: "23.5rem", height: "auto" }}>
                      ...
                      <Select
                        options={UoMDropDown}
                        onChange={(e) => {
                          setgetPurchasingUoMName(e.label);
                    ...
                    <CardGroup>
                      ...
                      <div style={{ width: "11.5rem", height: "auto" }}>
                        <Select
                          ...
                          onChange={(e) => {
                            setgetcustomgrouprate(e.item.Total);
                    ...
                    <CardGroup>
                      ...
                      <div style={{ width: "11.5rem", height: "auto" }}>
                        <Select
                          options={TaxCode}
                          onChange={(e) => {
                            setgettaxrate(e.item.VatGroups_Lines[0].Rate);
                      ...
                      <CardGroup>
                        ...
                        <div style={{ width: "11.5rem", height: "auto" }}>
                          <Select
                            options={SaleTaxCode}
                            onChange={(e) => {
                              setgetsaletaxrate(e.item.VatGroups_Lines[0].Rate);
                  ...
                  <Container fluid>
                    <div style={{ width: "23.5rem", height: "auto" }}>
                      ...
                      <Select
                        ...
                        options={[
                          { label: "Warehouse", value: "glm_WH" },
                          { label: "Item Group", value: "glm_ItemClass" },
                          { label: "Item Level", value: "glm_ItemLevel" },
                        ]}
                      />
                    </div>
                    <div style={{ width: "23.5rem", height: "auto" }}>
                      ...
                      <Select
                        options={UoMDropDown}
                        onChange={(e) => {
                          setgetinventoryUoMName(e.label);
                        ...
                        options={[
                          {
                            ...
                            value: "bis_MovingAverage",
                          },
                          { label: "Standard", value: "bis_Standard" },
                          { label: "FIFO", value: "bis_FIFO" },
                          { label: "Serial/Batch", value: "bis_Serial/Batch" },
                        ]}
                      />
                    </div>
                    {getvaluationmethod === "bis_Standard" ||
                    getvaluationmethod === "bis_MovingAverage" ? (
                      <>
                        <div style={{ width: "23.5rem", height: "auto" }}>
                  ...
                  <Container fluid>
                    ...
                    >
                      ...
                      <Select
                        ...
                        options={[
                          { label: "None", value: "bop_None" },
                          { label: "MRP", value: "bop_MRP" },
                        ]}
                      />
                    </div>
                    <div style={{ width: "23.5rem", height: "auto" }}>
                      ...
                      <Select
                        ...
                        options={[
                          { label: "Buy", value: "bom_Buy" },
                          { label: "Make", value: "bom_Make" },
                        ]}
                      />
                    </div>
                    <div style={{ width: "23.5rem", height: "auto" }}>
                      ...
                      <Select
                        ...
                        options={[
                          {
                            label: "From Bill of Materials Line",
                            value: "bomcw_BOM",
                          },
                          {
                            label: "From Parent Item Document Line",
                            value: "bomcw_PID",
                          },
                        ]}
                      />
