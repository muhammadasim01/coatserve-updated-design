...
export default function Invoice() {
  ...
  const handleShow = async () => {
    ...
    if (getcopyfromvalue === "PO") {
      let SAPapi = `PurchaseOrders?$filter=DocumentStatus eq 'bost_Open' and CardCode eq '${SelectedVendor}'`
      await axios
        .post(API_TYPES.GET, {
          api: SAPapi,
          cookie: cookie
      ...
      let SAPapi = `PurchaseDeliveryNotes?$filter=DocumentStatus eq 'bost_Open' and CardCode eq '${SelectedVendor}'`
      await axios
        .post(API_TYPES.GET, {
          api: SAPapi,
          cookie: cookie
  ...
  const UnitPriceChanged = (e, index, PrReIndex) => {
    ...
    let itemDetail = PQDocumentLines
    itemDetail[PrReIndex].DocumentLines[index][e.target.name] = e.target.value
    itemDetail[PrReIndex].DocumentLines[index]['Price'] = (itemDetail[PrReIndex].DocumentLines[index]["UnitPrice"] - (itemDetail[PrReIndex].DocumentLines[index]["UnitPrice"] * itemDetail[PrReIndex].DocumentLines[index]["DiscountPercent"]) / 100)
    itemDetail[PrReIndex].DocumentLines[index]['LineTotal'] = Number(itemDetail[PrReIndex].DocumentLines[index]["Price"]) * Number(itemDetail[PrReIndex].DocumentLines[index]["Quantity"])
    itemDetail[PrReIndex].DocumentLines[index]['GrossTotal'] = (Number(itemDetail[PrReIndex].DocumentLines[index]["Price"]) * Number(itemDetail[PrReIndex].DocumentLines[index]["Quantity"])) + Number(itemDetail[PrReIndex].DocumentLines[index]["TaxTotal"])
  ...
  const DocLinesDropDownOnChange = (selectedItem, index, PrReIndex, name) => {
    ...
    let itemDetail = PQDocumentLines
    itemDetail[PrReIndex].DocumentLines[index][name] = selectedItem.value
    itemDetail[PrReIndex].DocumentLines[index]['TaxTotal'] = Number(itemDetail[PrReIndex].DocumentLines[index]['LineTotal']) * (selectedItem.item.VatGroups_Lines[0].Rate) / 100
    itemDetail[PrReIndex].DocumentLines[index]['GrossTotal'] = (Number(itemDetail[PrReIndex].DocumentLines[index]["Price"]) * Number(itemDetail[PrReIndex].DocumentLines[index]["Quantity"])) + Number(itemDetail[PrReIndex].DocumentLines[index]["TaxTotal"])
          ...
          element.DocumentLines.forEach(item => {
            if (item.isSelected && item.LineStatus === 'bost_Open') {
              DocLines.push({
                ...
                BatchNumbers: BatchDocLines.filter(function (i) { return i.BaseLineNumber === item.LineNum && i.Location === item.ItemCode; }),
              ...
              body['DocDueDate'] = getdeliverydate ?getdeliverydate : currentDate
            }
          })
        }
      })
                  ...
                  <CardGroup>
                    ...
                    <div style={{ width: '11.5rem', height: 'auto' }}>
                      <input
                        ...
                        name='Discount'
                        readOnly
                        value={HeaderData && HeaderData.DocNum ? HeaderData && HeaderData.DocNum : getnextnumber}
                        placeholder=''
                        class='form-control'
                      /> <br />
                    </div>
              ...
              <br /> */}
                <div style={{ width: '23.5rem', height: 'auto', marginLeft: '3rem' }}>
                  ...
                  <input
                    ...
                    class='form-control'
                    defaultValue={HeaderData && HeaderData.DocDate ? HeaderData && HeaderData.DocDate : getpostingdate}
                  /></div>
                <div style={{ width: '23.5rem', height: 'auto', marginLeft: '3rem' }}>
                  <label> Due Date</label>
                  <input
            ...
            <Tab eventKey='Contents' title='Contents'>
                  ...
                  {Array.isArray(PQDocumentLines) &&
                    ...
                    <TableHead>
                      <tr>
                        ...
                        <th>Item Description</th>
                        <th>UoM Name</th>
                        {Array.isArray(getbatchnumbers) && getbatchnumbers.length > 0 && getcopyfromvalue === "PO" ? (<th>Batch</th>) : null}
                        <th>Free Text</th>
                        <th>Quantity</th>
                        <th>Delivery Date</th>
                        <th>Open Qty</th>
                            ...
                            (item, index) =>
                              ...
                              item.LineStatus === 'bost_Open' && (
                                <tr key={`${index}`}>
                                  ...
                                  <TD>{item.ItemDescription}</TD>
                                  <TD>{item.MeasureUnit}</TD>
                                  {Array.isArray(getbatchnumbers) && getbatchnumbers.length > 0 && getcopyfromvalue === "PO" ? (<TD>
                                    <Button onClick={(e) => { modalshow(item) }}> Batch </Button>
                                  </TD>) : null}
                                    ...
                                    <div style={{ width: '14rem' }}>
                                      {TaxCode && (
                                        ...
                                        menuPortalTarget={document.body}
                                          ...
                                          onChange={e => {
                                            DocLinesDropDownOnChange(e, index, PrReIndex, 'VatGroup')
                                          }}
                                    ...
                                    <div style={{ width: '15em' }}>
                                      {PrWhse && (
                                        ...
                                        menuPortalTarget={document.body}
                                          ...
                                          options={PrWhse} // Options to display in the dropdown
                                          onChange={e => {
                                            DocLinesDropDownOnChange2(e, index, PrReIndex, 'WarehouseCode')
                                          }}
                                          displayValue='name' // Property name to display in the dropdown options
                                        />
                                      )}
                                    ...
                                    <div style={{ width: '14rem' }}>
                                      {PrProject && (
                                        ...
                                        menuPortalTarget={document.body}
                                          ...
                                          // options={Frieght} // Options to display in the dropdown
                                          onChange={e => {
                                            DocLinesDropDownOnChange2(e, index, PrReIndex, 'ProjectCode')
                                          }}
                                          // onSelect={CostCentre} // Function will trigger on select event
                                          // onRemove={CostCentre} //Function will trigger on remove event
                                          displayValue='name' // Property name to display in the dropdown options
                                    ...
                                    <div style={{ width: '14rem' }}>
                                      {PrBuyer && (
                                        ...
                                        menuPortalTarget={document.body}
                                          ...
                                          // options={Frieght} // Options to display in the dropdown
                                          onChange={e => {
                                            DocLinesDropDownOnChange2(e, index, PrReIndex, 'SalesPersonCode')
                                          }}
                                          // onSelect={CostCentre} // Function will trigger on select event
                                          // onRemove={CostCentre} //Function will trigger on remove event
                                          displayValue='name' // Property name to display in the dropdown options
                                    ...
                                    <div style={{ width: '14rem' }}>
                                      {PrCost && (
                                        ...
                                        menuPortalTarget={document.body}
                                          ...
                                          // options={Frieght} // Options to display in the dropdown
                                          onChange={e => {
                                            DocLinesDropDownOnChange2(e, index, PrReIndex, 'CostingCode')
                                          }}
                                          // onSelect={CostCentre} // Function will trigger on select event
                                          // onRemove={CostCentre} //Function will trigger on remove event
                                          displayValue='name' // Property name to display in the dropdown options
              ...
              {(
                <Table responsive striped bordered hover>
                  ...
                  <tbody>
                    {SearchDocumentLines && SearchDocumentLines.map(
                      (item, index) =>
                        item.LineStatus === 'bost_Open' && (
                          <tr key={`${index}`}>
                            <TD>{index + 1}</TD>
                ...
                <div class='form-group'>
                  <div style={{ width: '23.5rem', height: 'auto' }}>
                    ...
                    <div style={{ width: '23.5rem' }}>
                      <textarea
                        defaultValue={getcopyfromvalue === "PO" ?
                          HeaderData &&
              ...
              <div>
                <div style={{ width: '23.5rem', marginLeft: '4rem' }}>
                  ...
                  <input
                    readOnly='readOnly'
                    type='number'
                    value = {totalbforeDiscount ? totalbforeDiscount : HeaderData &&  (HeaderData.DocTotalFc != 0 ? (HeaderData.DocTotalFc + HeaderData.TotalDiscountFC - HeaderData.VatSumFc) : (HeaderData.DocTotal + HeaderData.TotalDiscount + HeaderData.VatSum))}
                ...
                <div style={{ marginLeft: '4rem' }}>
                  ...
                  <CardGroup>
                    <div style={{ width: '11.75rem' }}>
                      <input
                        type='number'
                        value={discountpercent || HeaderData && HeaderData.DiscountPercent}
                        onChange={e => {
                    ...
                    <div style={{ width: '11.75rem' }}>
                      <input
                        ...
                        onChange={e => {
                          ...
                          setdiscountpercent((e.target.value / totalbforeDiscount) * 100)
                        }}
                        class='form-control'
                        name='TaxAmount(LC)'
                ...
                <CardGroup>
                  <div style={{ width: '11.75rem' }}>
                    <input
                      ...
                      name='DPM%'
                      class='form-control'
                      value={disc || HeaderData && HeaderData.DownPaymentPercentage}
                      onChange={e => {
                        setdisc(e.target.value)
                        setdownpayment((e.target.value * totalbforeDiscount) / 100)
                      }}
                      placeholder='%'
                    />
                  </div>
                  <div style={{ width: '11.75rem' }}>
                    <input
                      ...
                      name='DPMPKR'
                      class='form-control'
                      value={downpayment || HeaderData &&(HeaderData.DocTotalFc != 0 ? HeaderData.DownPaymentAmountFc : HeaderData.DownPaymentAmount)}
          ...
          <br /> */}
              <div style={{ width: '23.5rem', marginLeft: '4rem' }}>
                ...
                <input
                  ...
                  value={gettaxtotal || HeaderData &&(HeaderData.DocTotalFc != 0 ? HeaderData.VatSumFc : HeaderData.VatSum)}
                  name='TaxAmount(LC)'
                  placeholder='Tax'
                />
              </div>
              ...
              <div style={{ width: '23.5rem', marginLeft: '4rem' }}>
                ...
                <input type='text' value={Number(totalbforeDiscount) + Number(gettaxtotal) - Number(DiscountTotal) || HeaderData && (HeaderData.DocTotalFc != 0 ? HeaderData.DocTotalFc : HeaderData.DocTotal)} placeholder='' class='form-control' />
              </div>
              <div style={{ width: '23.5rem', marginLeft: '4rem' }}>
                <label>Blanace Due:</label>
                <input type='text' value={Number(totalbforeDiscount) + Number(gettaxtotal) - Number(DiscountTotal) || HeaderData && (HeaderData.DocTotalFc != 0 ? (HeaderData.DocTotalFc - HeaderData.PaidToDateFC) : (HeaderData.DocTotal - HeaderData.PaidToDate))} placeholder='PaidToDateFC' class='form-control' />
              </div>
            </DIV3>
          </CardGroup>
        </ContextMenuTrigger>
