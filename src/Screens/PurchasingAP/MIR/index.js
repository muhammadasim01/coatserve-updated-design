...
const [currentComDate, setcurrentComDate] = React.useState(new Date().getFullYear() + '-' +(new Date().getMonth() + 1) + '-' + new Date().getDate())
  ...
  const [
    CheckindRuleCodeDropDoen,
    setCheckindRuleCodeDropDoen
  ] = React.useState()
  ...
  const verifyvalue = e => {
    if ((Number(e.target.value) + Number(RejectQty)) > (MIRDocumentLines.U_Quantity)) {
      alert.error('Enter Value Equal to IGP_Quantity')
    }else if ((Number(e.target.value) + Number(RejectQty)) < MIRDocumentLines.U_Quantity) {
      alert.error('Enter Value Equal to IGP_Quantity')
    }
    else if ((Number(e.target.value) + Number(RejectQty)) == MIRDocumentLines.U_Quantity) {
      alert.success('Value added Suucessfully')
  ...
  const verifyvalue2 = e => {
    if ((Number(e.target.value) + Number(ApprovedQty)) > (MIRDocumentLines.U_Quantity)) {
      alert.error('Enter Value Equal to IGP_Quantity')
    }else if ((Number(e.target.value) + Number(ApprovedQty)) < MIRDocumentLines.U_Quantity) {
      alert.error('Enter Value Equal to IGP_Quantity')
    }
    else if ((Number(e.target.value) + Number(ApprovedQty)) == MIRDocumentLines.U_Quantity) {
      alert.success('Value added Suucessfully')
        ...
        <DIV3>
          ...
          <label>Vendor</label>
            <div style={{ width: '23.5rem', height: 'auto' }}>
              <Select
                placeholder={SelectedPRDocEntry && SelectedPRDocEntry.CardCode || PQHeaderData && PQHeaderData.CardCode}
        ...
        <Modal.Footer>
          ...
          <Button variant='primary' onClick={handleClose2}>
            ...
            <div style={{ width: '23.5rem', height: 'auto' }}>
              <label>IGP No.</label>
              <input
                defaultValue={SelectedPRDocEntry && SelectedPRDocEntry.DocEntry || PQHeaderData && PQHeaderData.DocEntry}
                type='number'
                class='form-control'
                id='vendor'
            ...
            <div style={{ width: '23.5rem', height: 'auto' }}>
              ...
              <input
                defaultValue={MIRDocumentLines && MIRDocumentLines.U_BaseEntry||PQHeaderData && PQHeaderData.U_BaseEntry}
                type='number'
                class='form-control'
                readOnly
                id='RefNum'
            ...
            <div style={{ width: '23.5rem', height: 'auto' }}>
              ...
              <input
                value={MIRDocumentLines && MIRDocumentLines.U_unitMsr||PQHeaderData && PQHeaderData.U_unitMsr}
                type='text'
                class='form-control'
                id='UoM'
                aria-describedby='emailHelp'
            ...
            <div style={{ width: '23.5rem', height: 'auto' }}>
              ...
              <input
                ...
                aria-describedby='emailHelp'
                value={ApprovedQty}
                defaultValue={MIRDocumentLines && MIRDocumentLines.U_AQuantity||PQHeaderData && PQHeaderData.U_AQuantity}
                onChange={e => {
        ...
        <DIV3>
            ...
            <CardGroup>
              ...
              {/* <div style={{ width: '11.5rem', height: 'auto' }} >
                <Select
                  ...
                  onChange={e=>{getseriesvaluefunction(e)}} // Function will trigger on select event
                  // onRemove={RequesterCodeDropdownfunc} // Function will trigger on remove event
                  displayValue='name' // Property name to display in the dropdown options
                />
              </div> */}
              <div style={{ width: '23rem', height: 'auto'  }}>
                <input
                  type='number'
                  name='Discount'
                  readOnly
          ...
          <div className="MIR"
            ...
            >
              <a onClick={e => {
                ...
                }} style={{cursor:'pointer'}}> <svg class="svg-icon16" viewBox="0 0 20 20">
          ...
          {/* <div style={{ width: '23.5rem', height: 'auto',marginLeft:'3rem' }}>
            ...
            <div style={{ width: '23.5rem', height: 'auto',marginLeft:'3rem' }}>
              <label>IGP Row #</label>
              <input
                defaultValue={MIRDocumentLines && MIRDocumentLines.LineId||PQHeaderData && PQHeaderData.LineId}
                type='number'
                class='form-control'
                id='IGPRowNo'
                aria-describedby='emailHelp'
            ...
            <div style={{ width: '23.5rem', height: 'auto',marginLeft:'3rem' }}>
              <label>Item</label>
              <input
                defaultValue={MIRDocumentLines&&MIRDocumentLines.U_ItemCode + ' : ' +MIRDocumentLines&&MIRDocumentLines.U_Dscription || PQHeaderData&&PQHeaderData.U_ItemCode + ' : ' +PQHeaderData&&PQHeaderData.U_Dscription}
                type='text'
                class='form-control'
                id='IGPRowNo'
                aria-describedby='emailHelp'
            ...
            <div style={{ width: '23.5rem', height: 'auto',marginLeft:'3rem' }}>
              ...
              <input
                ...
                aria-describedby='emailHelp'
                readOnly
                defaultValue={PQHeaderData && PQHeaderData.U_IGPQuantity || MIRDocumentLines && MIRDocumentLines.U_Quantity}
                // onClick={e => {
                //     ApprovedQtyFun()
                //   }}
              ></input>
            ...
            <div style={{ width: '23.5rem', height: 'auto' ,marginLeft:'3rem'}}>
              ...
              <input
                ...
                id='RejectedQty'
                aria-describedby='emailHelp'
                defaultValue={PQHeaderData && PQHeaderData.U_RQuantity || MIRDocumentLines && MIRDocumentLines.U_RQuantity}
                placeholder=''
                onChange={e => {
      ...
      <CardGroup>
        <DIV3>
          ...
          <div style={{ width: '23.5rem', height: 'auto' }}>
              ...
              <textarea
                defaultValue={SelectedPRDocEntry && SelectedPRDocEntry.Remark||PQHeaderData && PQHeaderData.Remark}
                type='text'
                class='form-control'
                id='TimeOut'
                aria-describedby='emailHelp'
