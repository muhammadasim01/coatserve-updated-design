...
const [currentComDate, setcurrentComDate] = React.useState(new Date().getFullYear() + '-' +(new Date().getMonth() + 1) + '-' + new Date().getDate())
  ...
  const requesterDropDownfunc = async selectedOption => {
    ...
    if (selectedOption.value === 171) {
      ...
      .then(function (res) {
        ...
        {
          alert(  `Items Details Response Error : <-- ${res.data.error.message.value} -->`)
        }
      })
      .catch(function (error) {
        console.log(error)
  ...
  const submitPR = async () => {
    ...
    body['RequriedDate'] = PRBody.RequriedDate ? PRBody.RequriedDate : currentDate
  ...
  const DocLinesDropDownOnChange2 = (selectedItem, item,name) => {
    ...
    let SelectedDocLines = []
      itemDetail[item][name] = selectedItem.value
      itemDetail[item]['TaxAmount'] = Number(selectedItem.item.VatGroups_Lines[0].Rate)
      ...
      itemDetail[item]["Total_LC"] =((Number(itemDetail[item].PriceAfterDiscount * Number(itemDetail[item].Quantity)) + Number(itemDetail[item].TaxAmount)) )
...
getdocumentname={getdocumentname}
            ...
            <Container fluid>
              ...
              <div style={{ width: '23.5rem', height: 'auto' }}>
                <Select
                  ...
                  onChange={e=>{setgetdepartment(e.value)}} // Function will trigger on select event
                  // onRemove={RequesterCodeDropdownfunc} // Function will trigger on remove event
                  displayValue='name' // Property name to display in the dropdown options
                />
              </div>
              ...
              <div style={{ width: '23.5rem', height: 'auto' }}>
                ...
                <input
                  ...
                  defaultValue={getemail ? getemail : HeaderData && HeaderData.RequesterEmail}
          ...
          <DIV3>
            ...
            >
              <a onClick={e => {
                ...
                }} style={{cursor:'pointer'}}> <svg class="svg-icon10" viewBox="0 0 20 20">
                              ...
                              <div style={{ width: '15em' }}>
                                {PrVendor && (
                                  ...
                                  menuPortalTarget={document.body}
                                    ...
                                    onChange={e => {
                                      FindDocLinesDropDownOnChange(e, index, 'LineVendor')
                                    }}
      ...
      <MaterialTable title="Olympic Data" data={data}
