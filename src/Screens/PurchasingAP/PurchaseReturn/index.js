      ...
      <CardGroup>
        <DIV3>
          <Container fluid>
            ...
            <div style={{ width: '23.5rem', height: 'auto' }} variant='primary' onClick={ContactP} >
              <Select
...
<Modal show={show} onHide={handleClose} className="Modal-big" size="lg">
        <Modal.Header closeButton>
          <Modal.Title id="example-modal-sizes-title-lg">Open Goods Receipt PO List</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          {PrRe && (
            <Table responsive>
          ...
          <div className="Return"
            ...
            >
              <a onClick={e => {
                ...
                }} style={{cursor:'pointer'}}> <svg class="svg-icon18" viewBox="0 0 20 20">
                  ...
                  <div style={{ width: '11rem' }}>
                    {PrCost && (
                      ...
                      menuPortalTarget={document.body}
                        ...
                        options={PrCost} // Options to display in the dropdown
                        onChange={e => {
                          DocLinesDropDownOnChange(e, index, PrReIndex,'CostingCode')
                        }}
                        displayValue='name' // Property name to display in the dropdown options
                      />
                    )}
                  ...
                  <div style={{ width: '11rem' }}>
                    {PrProject && (
                      ...
                      menuPortalTarget={document.body}
                        ...
                        options={PrProject} // Options to display in the dropdown
                        onChange={e => {
                          SearchDocLinesDropDownOnChange(e, index, 'ProjectCode')
                        }}
                        // onSelect={Project} // Function will trigger on select event
                        // onRemove={Project} //Function will trigger on remove event
                        displayValue='name' // Property name to display in the dropdown options
                  ...
                  <div style={{ width: '11rem' }}>
                    {PrCost && (
                      ...
                      menuPortalTarget={document.body}
                        ...
                        options={PrCost} // Options to display in the dropdown
                        onChange={e => {
                          SearchDocLinesDropDownOnChange(e, index, 'CostingCode')
                        }}
                        displayValue='name' // Property name to display in the dropdown options
                      />
                    )}
        ...
        <DIV3>
          ...
          <div class='form-group'>
              ...
              <textarea
                ...
                rows='3'
                value={HeaderData && HeaderData.Comments + ":" + HeaderData.DocEntry}
                onChange={e => {
