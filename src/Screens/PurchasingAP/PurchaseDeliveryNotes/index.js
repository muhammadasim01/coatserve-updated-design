        ...
        {PQDocumentLines && (
              ...
              PrReItem.DocumentLines.map((item, index) => (
                ...
                <input
                  ...
                  // defaultValue={SelectedPRDocEntry && SelectedPRDocEntry.DocDueDate || HeaderData && HeaderData.DocDueDate}
                  onChange={e => {
                    getvaluefrombatchtable(e, index,PrReIndex)
                  }}
                />
              </div>
                    </TD>
            ...
            <Container fluid>
              ...
              <div style={{ width: '23.5rem' }}>
                ...
                <textarea
                  ...
                  defaultValue={
                    HeaderData && HeaderData.Comments + ':' +  HeaderData.DocEntry
                  }
                />
                </div>
                </div>
