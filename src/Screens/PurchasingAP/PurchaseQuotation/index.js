...
export default function PurchaseRequest() {
  ...
  const [JournalRemarkAccounting, setJournalRemarkAccounting] =
    React.useState();
  ...
  const DocLinesDropDownOnChange = (selectedItem, index, PrReIndex, name) => {
    ...
    itemDetail[PrReIndex].DocumentLines[index]["TaxRate"] =
    ...
    itemDetail[PrReIndex].DocumentLines[index]["TaxTotal"] =
      (itemDetail[PrReIndex].DocumentLines[index].PriceAfterVAT *
        itemDetail[PrReIndex].DocumentLines[index].RemainingOpenQuantity *
        itemDetail[PrReIndex].DocumentLines[index].TaxRate) /
      100;
  ...
  const PriceFun = (e, index, PrReIndex) => {
    ...
    PQDocumentLines[PrReIndex].DocumentLines[index]["PriceAfterVAT"] =
      PQDocumentLines[PrReIndex].DocumentLines[index].UnitPrice -
      (PQDocumentLines[PrReIndex].DocumentLines[index].UnitPrice *
        PQDocumentLines[PrReIndex].DocumentLines[index].DiscountPercent) /
        100;
    PQDocumentLines[PrReIndex].DocumentLines[index]["Total_LC"] =
      PQDocumentLines[PrReIndex].DocumentLines[index].PriceAfterVAT *
      PQDocumentLines[PrReIndex].DocumentLines[index].Quantity;
    ...
    PQDocumentLines[PrReIndex].DocumentLines[index]["TaxTotal"] =
      (PQDocumentLines[PrReIndex].DocumentLines[index].PriceAfterVAT *
        PQDocumentLines[PrReIndex].DocumentLines[index].RemainingOpenQuantity *
        PQDocumentLines[PrReIndex].DocumentLines[index].TaxRate) /
      100;
    PQDocumentLines[PrReIndex][`ùpdate${update + 1}`] = update + 1;
    setUpdate(update + 1);
    setPQDocumentLines(doclines);
                ...
                <Container fluid>
                  ...
                  >
                    <Select
                      placeholder={
                        PQFindDocumentLines &&
                        PQFindDocumentLines.ContactPersonCode
                      }
