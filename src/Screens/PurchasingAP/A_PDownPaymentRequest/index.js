    ...
    Choose
      ...
      <Modal show={show1} onHide={handleClose2}>
        ...
        <DIV3>
          ...
          <div className="Down" style={{ width: '23.5rem', height: 'auto', marginLeft: '3rem' ,border:'1px solid',borderColor:'lightgray',borderRadius:'4px'}}
            >
              <a onClick={e => {
                  SearchAll_Filter_Data()
                }} style={{cursor:'pointer'}}> <svg class="svg-icon14" viewBox="0 0 20 20">
            ...
            <Table responsive striped bordered hover>
              ...
              {SearchDocumentLines && SearchDocumentLines.map((item, index) => (
                  ...
                  <tr key={`${index}`}>
                    ...
                    <TD>
                    {item.DocumentLineAdditionalExpenses?item.DocumentLineAdditionalExpenses[0].LineTotal : ""}
                    </TD>
                    <TD>
                    {item.LineTotal}
                    </TD>
          ...
          <Container fluid>
            <div style={{ width: '23.5rem' }}>
              ...
              <Select
                displayValue='name' 
                placeholder={
                 HeaderData && HeaderData.SalesEmployeeName
                }
              />
            </div>
            <div style={{ width: '23.5rem', height: 'auto' }} >
            ...
            <textarea
              ...
              name='Comments'
              onChange={e=>{setgetcomments(e.target.value)}}
              rows='3'
              placeholder=' '
        ...
        <DIV3>
            ...
            <div style={{marginLeft:'4rem'}}>
              ...
              <input
                ...
                onChange={e => {
                  ...
                  setdownpayment((e.target.value * (getnetTotal||totalbforeDiscount)) / 100)
                }}
                placeholder='%'
              />
              </div>
              ...
              <input
                ...
                name='DPMPKR'
                class='form-control'
                value={downpayment||(HeaderData&&HeaderData.DownPaymentAmountSC)}
                placeholder='PKR'
                onChange={e => {
          ...
          />
           ...
           <div style={{width:'23.5rem' , marginLeft:'4rem'}}>
            ...
            <input type='text' 
            value={Number(Totaltax||gettaxtotal) + Number(downpayment||(HeaderData&&HeaderData.DownPaymentAmountSC))||(HeaderData&&HeaderData.DocTotal)} 
            placeholder='' class='form-control' />
            </div>
            <div style={{width:'23.5rem' , marginLeft:'4rem'}}>
            <label>Blanace Due:</label>
            <input type='text' value={Number(Totaltax||gettaxtotal) + Number(downpayment||(HeaderData&&HeaderData.DownPaymentAmountSC))||(HeaderData&&HeaderData.DocTotalSys)}  placeholder='' class='form-control' />
            </div>
        </DIV3>
      </CardGroup>
      </Form>
