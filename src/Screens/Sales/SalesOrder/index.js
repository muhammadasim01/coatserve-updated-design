  ...
  const getvaluesformula = () =>{
    ...
    PQDocumentLines.forEach(element => {
      ...
      const DocLinesDropDownOnChange22 = (selectedItem, index, name) => {
        ...
        obj[index]["TaxRate"] = obj[index].PriceAfterVAT * (selectedItem.item.VatGroups_Lines[0].Rate / 100)
        obj[index]["LineTotal"] = obj[index].PriceAfterVAT * obj[index].RequiredQuantity 
        ...
        <DIV3>
          ...
          <label>Doc Type</label>
            <div style={{ width: '23.5rem', height: 'auto' }} variant='primary' >
              <Select
                placeholder={HeaderData && HeaderData.DocType ? HeaderData && HeaderData.DocType : 'Direct'}
                options={[
          ...
          <input
            ...
            <input
             ...
             aria-describedby='emailHelp'
              type='date'
              name='TaxDate'
              defaultValue={HeaderData && HeaderData.DocDueDate ? HeaderData && HeaderData.DocDueDate : DueDate}
            onChange={e => {
                ...
                <TD>
                  <div style={{ width: '14rem', height: 'auto' }}>
                    <input
                      ...
                      class='form-control'
                      aria-describedby='Requesterid'
                      value={item.RequiredDate?item.RequiredDate:DueDate}
                      onChange={e => {
                        itemsChange(e, index)
                      }}
                    />
          ...
          <Container fluid>
            ...
            <div class="form-group" style={{ width: '23.5em', height: 'auto' }}>
              ...
              <textarea 
                ...
                value={HeaderData && "Document Entry : " + HeaderData.DocEntry + ". " + HeaderData.Comments}
                type='text'
