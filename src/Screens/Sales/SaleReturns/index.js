    ...
    Choose
        ...
        <DIV3>
          ...
          <div className="Return"
            ...
            >
              <a onClick={e => {
                ...
                }} style={{cursor:'pointer'}}> <svg class="svg-icon8" viewBox="0 0 20 20">
          ...
          <input
            ...
            <br/><div style={{ width: '23.5rem',marginLeft:'3rem' }}>
            ...
            <input
              ...
              name='DocDuDate'
              class='form-control'
              defaultValue={HeaderData && HeaderData.DocDuDate ? HeaderData && HeaderData.DocDuDate : currentDate}
              onChange={e => {
                DocDateChange(e)
              }}
            />
      ...
      <CardGroup>
        <DIV3>
          <Container fluid>
            ...
            <div class="form-group">
              ...
              <textarea 
                defaultValue={HeaderData && "Based on Deliveries: " + HeaderData.DocEntry + ". " + HeaderData.Comments}
                type='text'
        ...
        <DIV3>
          ...
          <div style={{ width: '23.5rem',marginLeft:'4rem' }}>
            ...
            <input type='text'
             value={((totalbforeDiscount-DiscountTotal)+gettaxtotal)|| HeaderData && HeaderData.DocTotal.toFixed(2)}
             placeholder='' 
             readOnly='readOnly'
              class='form-control' />
          </div>
