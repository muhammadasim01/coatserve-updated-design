...
export default function PurchaseRequest() {
 ...
 // informational hooks
  ...
  const itemsChange = (e, index) => {
    ...
    obj[index]["LineTotal"] = obj[index].PriceAfterVAT * obj[index].RequiredQuantity
    obj[index]["TaxAmount_LC"] = (obj[index]["PriceAfterVAT"] * (obj[index]["RequiredQuantity"] * obj[index]["TaxRate"]) / 100)
  ...
  const itemsChange22 = (e, index) => {
    let obj = selectedItems
    obj[index]["PriceAfterVAT"] = (obj[index]["UnitPrice"] - (obj[index]["UnitPrice"] * obj[index]["DiscountPercent"]) / 100)
    obj[index]["LineTotal"] = obj[index].PriceAfterVAT * obj[index].RequiredQuantity
    obj[index][`ùpdate${update+1}`]= update+1;
    setUpdate(update+1);
    let sum = 0
  ...
  const testing = (e, index) => {
    let obj = selectedItems
    obj[index][e.target.name] = e.target.value
    obj[index]["UnitPrice"] = getautounitprice && getautounitprice[obj[index]['ItemCode']].Price + (getautounitprice && getautounitprice[obj[index]['ItemCode']].Price * getautounitprice && getautounitprice[obj[index]['ItemCode']].DiscountPercent / 100)
    obj[index]["DiscountPercent"] = getautounitprice && getautounitprice[obj[index]['ItemCode']].DiscountPercent 
    obj[index]["LineTotal"] = getautounitprice && getautounitprice[obj[index]['ItemCode']].Price * obj[index].RequiredQuantity
    obj[index]["TaxAmount_LC"] = (getautounitprice && getautounitprice[obj[index]['ItemCode']].Price * (obj[index]["RequiredQuantity"] * obj[index]["TaxRate"]) / 100)
    obj[index][`ùpdate${update+1}`]= update+1;
    setUpdate(update+1);
    let sum = 0
    obj.forEach(element => {
  ...
  const DocLinesDropDownOnChange22 = (selectedItem, index, name) => {
   ...
   obj[index]["LineTotal"] = obj[index].PriceAfterVAT * obj[index].RequiredQuantity + obj[index].TaxRate
   obj[index]['TaxAmount_LC'] =
   (obj[index].PriceAfterVAT *
   obj[index].RequiredQuantity *  obj[index].PriceAfterVAT)/100 
   obj[index][`ùpdate${update+1}`]= update+1;
   setUpdate(update+1);
   let sum = 0
   let sum1 = 0
        ...
        <Modal.Footer>
          ...
          <Button variant='primary' onClick={handleClose2}>
            ...
            <input
              ...
              name='DocDueDate'
              class='form-control'
              defaultValue={HeaderData && HeaderData.DocDueDate ? HeaderData && HeaderData.DocDueDate : currentDate}
              onChange={e => {
                dateChange(e)
              }}
            />
            ...
            <input
              ...
              name='RequriedDate'
              class='form-control'
              defaultValue={HeaderData && HeaderData.RequriedDate ? HeaderData && HeaderData.RequriedDate : currentDate}
              onChange={e => {
                requireDateChange(e)
              }}
            />
        ...
        <tbody>
          {selectedItems&&selectedItems.map((item, index) => (
            <tr key={`${index}`}>
              ...
              <TD> {getautounitprice && getautounitprice[item.ItemCode] ? (
                <div style={{ width: '14rem', height: 'auto' }}>
                  <input
                    ...
                    value={item.ItemCode ? item.RequiredQuantity :''}
                    onChange={e => {
                      testing(e, index)
                    }}
                  />
              ...
              <TD>
                <div style={{ width: '14rem', height: 'auto' }}>
                  <input
                    ...
                    class='form-control'
                    aria-describedby='Requesterid'
                    value={item.RequiredDate?item.RequiredDate:currentDate}
                    onChange={e => {
                      itemsChange(e, index)
                    }}
                  />
              ...
              <TD>  {getautounitprice && getautounitprice[item.ItemCode] ? (
                <div style={{ width: '14rem', height: 'auto' }}>
                  ...
                  <input
                    ...
                    readOnly
                    aria-describedby='Requesterid'
                    value={item.ItemCode ? item.PriceAfterVAT :''}
                  />
                </div>)}
              </TD>
                ...
                <div style={{ width: '14rem' }}>
                  ...
                  <Select
                   value={TaxCode.filter(
                    ...
                    onChange={e => {
                      DocLinesDropDownOnChange22(e, index, 'VatGroup')
                    }}
                    displayValue='name' // Property name to display in the dropdown options
                  />)}
                </div>) : (
              ...
              <TD> {getautounitprice && getautounitprice[item.ItemCode] ? (
              Number(item.TaxRate) + Number(getautounitprice && getautounitprice[item.ItemCode].Price)
              ) : (  Number(item.TaxRate) + Number(item.PriceAfterVAT))}
              </TD>
              <TD> {getautounitprice && getautounitprice[item.ItemCode] ? (
                <div style={{ width: '14rem', height: 'auto' }}>
                  <input
                    ...
                    readOnly
                    aria-describedby='Requesterid'
                    value={item.ItemCode ? getautounitprice && getautounitprice[item.ItemCode].Price * item.RequiredQuantity : ''}
                    name='Total_LC'
                  />
                </div>):(
                <div style={{ width: '14rem', height: 'auto' }}>
              ...
              <TD>{getautounitprice && getautounitprice[item.ItemCode] ? (
                ...
                <div style={{ width: '14rem', height: 'auto' }}>
                  <input
                    ...
                    id='Requesterid'
                    aria-describedby='Requesterid'
                    value={item.ItemCode ? ( item.PriceAfterVAT * item.RequiredQuantity) : ''}
                  />
                </div>)}
              </TD>
              <TD>
            ...
            <Table responsive striped bordered hover>
              ...
              <tbody>
                {PQDocumentLines && PQDocumentLines.map((item, index) => (
                    ...
                    <div style={{ width: '15em' }}>
                        {PrWhse && (
                          ...
                          menuPortalTarget={document.body}
                            ...
                            options={PrWhse} // Options to display in the dropdown
                            onChange={e => {
                              DocLinesDropDownOnChange2(e, index, 'WarehouseCode')
                            }}
                           displayValue='name' // Property name to display in the dropdown options
                          />
                        )}
          ...
          <Container fluid>
            ...
            <div class="form-group" style={{ width: '23.5rem', height: 'auto' }} >
              ...
              <textarea class="form-control rounded-0" id="exampleFormControlTextarea1" rows="3"
                defaultValue={HeaderData && HeaderData.Comments + ":" + HeaderData.DocEntry} />
            </div>
            <br />
            <br />
            <div>
          ...
          <div>
            ...
            <input
             ...
             class='form-control'
              ...
              placeholder={disc || HeaderData && HeaderData.DiscountPercent }
            />
            </div>
            <div  style={{ width: '11.75rem' }}>
            <input
         ...
         <div style={{ width: '23.5rem', marginLeft: '3rem' }}>
          <label>Tax</label>
            <input
              ...
              name='TaxAmount(LC)'
              readOnly='readOnly'
              defaultValue={TotalTaxRate|| HeaderData && (HeaderData.DocTotalFc != 0 ? HeaderData.VatSumFc : HeaderData.VatSum) }
               />
          </div>
          <div style={{ width:'23.5rem' , marginLeft: '3rem'}}>
            <label>Total Payment Due:</label>
            <input type='text'
             value={((totalbforeDiscount - DiscountTotal ) + TotalTaxRate) || HeaderData && (HeaderData.DocTotalFc != 0 ? HeaderData.DocTotalFc : HeaderData.DocTotal)}
              placeholder='' 
              readOnly='readOnly'
              class='form-control' />
          </div>
