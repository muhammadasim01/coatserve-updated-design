  ...
  const submitDelivery = async () => {
    ...
    PQDocumentLines.forEach(element => {
      ...
      DocLines.push({
        ...
        BatchNumbers: docLines2.filter(function(i){ return i.ItemCode == item.ItemCode; })
      })
...
<Form >
          ...
          <Container fluid>
            ...
            <Modal show={show} onHide={handleClose} className="Modal-big" size="lg">
              <Modal.Header closeButton>
                <Modal.Title id="example-modal-sizes-title-lg">Open Orders List</Modal.Title>
              </Modal.Header>
              <Modal.Body>
                {PrRe && (
                  <Table responsive>
    ...
    Choose
          ...
          <div className="Delivery"
            ...
            >
              <a onClick={e => {
                ...
                }} style={{cursor:'pointer'}}> <svg class="svg-icon6" viewBox="0 0 20 20">
      ...
      {/* Table+++++++++ */}    
      <br/>
            <Modal show={show3} onHide={handleClose3} className="Modal-big" size="lg">
        <Modal.Header closeButton>
                ...
                item.isSelected &&
                  ...
                  <tr key={`${index}`}>
                    ...
                    <TD>
                      <div style={{ width: '14rem', height: 'auto' }}>
                        <input
                          ...
                          aria-describedby='Requesterid'
                          defaultValue={item.Quantity}
                          onChange={e=>OpenQtyFunction(e, index,PrReIndex)
                          // setOpenQty(e.target.value)
                          }
                          // onChange={e => {
                          //   OpenQtyFunction(e, index)
                    ...
                    <div style={{ width: '14rem' }}>
                        <Select
                                            menuPortalTarget={document.body}
                       value={PrProject && PrProject.filter(
                        option => option.value === item.WarehouseCode
                      )}
                          placeholder={item.ProjectCode}
                          options={PrProject} // Options to display in the dropdown
                          onChange={e => {
                            DocLinesDropDownOnChange(e, index,PrReIndex, 'ProjectCode')
                          }}
                          // onSelect={CostCentre} // Function will trigger on select event
                          // onRemove={CostCentre} //Function will trigger on remove event
                          displayValue='name' // Property name to display in the dropdown options
            ...
            <Table responsive striped bordered hover>
              ...
              {SearchDocumentLines && SearchDocumentLines.map((item, index) => (
                  <tr key={`${index}`}>
                    ...
                    <TD>{item.RemainingOpenQuantity ? OpenQty:null} </TD>
                    <TD>
                    <div style={{ width: '15em' }}>
                        {PrWhse && (
                          <Select
        ...
        <DIV3>
          <Container fluid>
            ...
            <div class="form-group">
              ...
              <textarea 
                defaultValue={HeaderData && "Based on Orders: " + HeaderData.DocEntry + ". " + HeaderData.Comments}
                type='text'
        ...
        <DIV3>
          <div>
            ...
            <input
              ...
              class='form-control'
              name='TaxAmount(LC)'
              value={DiscountTotal|| HeaderData && HeaderData.TotalDiscountSC }
             />
            </div>
            </CardGroup>
            </div>
         ...
         />
          ...
          <div style={{ width: '23.5rem' ,marginLeft:'4rem' }}>
            ...
            <input type='text'
              value={ ((getnetTotal-DiscountTotal)+gettaxtotal)|| HeaderData && HeaderData.DocTotal}
              placeholder='' 
              readOnly='readOnly'
              class='form-control' />
          </div>
