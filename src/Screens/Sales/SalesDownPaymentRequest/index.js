...
if (bothbodies) {
  ...
  const QuantityFun = (index) => {
    let doclines = PQDocumentLines;
    doclines[index]['Total_LC'] = (doclines[index].Quantity * doclines[index].PriceAfterVAT);
    setPQDocumentLines(doclines);
  }
      ...
      <CardGroup>
        ...
        <DIV3>
           ...
           <div style={{ width: '23.5rem' ,marginLeft:'4rem'}}>
            ...
            <div style={{marginLeft:'4rem'}}>
              ...
              <input
                ...
                name='DPM%'
                class='form-control'
                defaultValue={disc||HeaderData&&HeaderData.DownPaymentPercentage}
                onChange={e => {
                  setdisc(e.target.value)
                  setdownpayment((e.target.value * getnetTotal) / 100)
                }}
                placeholder='%'
              />
              </div>
              ...
              <input
                ...
                name='DPMPKR'
                class='form-control'
                defaultValue={downpayment||HeaderData&&HeaderData.DownPaymentAmountSC}
          ...
          <div style={{width:'23.5rem',marginLeft:'4rem'}}>
            ...
            <input 
            type='number' 
            value={Number(gettaxtotal) + Number(downpayment)||HeaderData&&HeaderData.DocTotal} 
            placeholder='' 
            class='form-control' />
            </div>
            <div style={{width:'23.5rem',marginLeft:'4rem'}}>
            ...
            <input 
            type='number' 
            value={Number(gettaxtotal) + Number(downpayment)||HeaderData&&HeaderData.DocTotalSys}  
            placeholder='' 
            class='form-control' />
            </div>
        </DIV3>
