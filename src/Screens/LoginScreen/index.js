      ...
      .then(async function (response) {
        ...
        if (response.data.body.SessionTimeout) {
          ...
          resp.forEach((element) => {
            cook2 =
              cook2 +
              element.replace("Path=/; Secure; HttpOnly; SameSite=Lax", "");
          });
          if (cook2) {
        ...
        <>
          <div className="logincontainer">
            ...
            <TextInput
              ...
              placeholder={
                CONSTANTS.LoginScreen.InputFields.userNamePlaceholder
              }
            />
            ...
            <TextInput
              ...
              placeholder={
                CONSTANTS.LoginScreen.InputFields.passwordPlaceholder
              }
            />
            <div
