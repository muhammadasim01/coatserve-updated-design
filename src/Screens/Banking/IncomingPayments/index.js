...
export default function IncomingPayments() {
  ...
  const getDocnumberfun = (invoicedata, cook) => {
    ...
    let obj3 = invoicedata.filter((option) => {
      return option.InvoiceType !== "it_Invoice";
    });
    let DocLines = [];
    obj.forEach((element) => {
    ...
    prData.forEach((element) => {
      if (element.isSelected) {
        sum =
          ...
          (element.DocTotal
            ? element.DocTotal - element.PaidToDate
            : element.BalDueDeb - element.BalDueCred);
                ...
                {PrRe.map((item, index) => (
                  <tr key={`${index}`}>
                    ...
                    <TD>
                      ...
                      {item.DownPaymentType === "dptInvoice"
                        ? "IN"
                        : item.TransType === "-2"
                        ? "OB"
                        : "JE"}
                    ...
                    <TD>
                      <input
                        ...
                        defaultValue={
                          ...
                          item.BalDueDeb - item.BalDueCred
                        }
                        onChange={(e) => {
                ...
                {SearchDocumentLines.map((item, index) => (
                  <tr key={`${index}`}>
                    ...
                    <TD>
                      ...
                      {item.DocNum ? item.DocNum : item.DocEntry}
                    </TD>
                    <TD>
                      {item.InvoiceType === "it_Invoice"
                        ? "IN"
