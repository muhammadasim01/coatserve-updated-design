...
getdocumentname={getdocumentname}
      ...
      <Form onSubmit={handleSubmit}>
        <CardGroup>
          ...
          <Container fluid> 
        <CardGroup>
        <div style={{ width: '10em', height: 'auto',marginRight:'2rem' }}>
        ...
        <label>Series</label>
          ...
          <label>No</label>
                <input
                  ...
                  name='No'
                  readOnly
                  value={getnextnumber || HeaderData && HeaderData.Number}
                  placeholder=''
                  class='form-control'
                /> <br/>
              </div>
          <div style={{ width: '10rem', height: 'auto' ,marginLeft:'2rem' }}>
            <label>Posting Date</label>
              <input
                ...
                name='PostingDate'
                class='form-control'
                defaultValue={ HeaderData && HeaderData.ReferenceDate ?  HeaderData && HeaderData.ReferenceDate : currentDate }
                onChange={e => {
            ...
            <label>Doc Date</label>
              ...
              <div style={{ width: '20rem', height: 'auto' ,marginLeft:'2rem' }}>
            <label>Remarks</label>
              <input
                type='text'
                name='Remarks'
              ...
              <br/>
              <div className="username" style={{ width: '9rem',marginLeft:'2rem',marginTop:'2rem',borderColor: 'lightgray'  }}>
              <a onClick={e => {
                  SearchAll_Filter_Data()
                }} style={{cursor:'pointer'}}> <svg class="svg-icon1" viewBox="0 0 20 20">
            ...
            <label>Ref.3</label>
              ...
              <CardGroup>
                {getcopyfromdoctype?(<>
               <div style={{ width: '22rem', height: 'auto' }} onClick={GetItems}>
            ...
            <Select
                  ...
                  />
                      ...
                      {getdirectdoctype?(<>
               <div style={{ width: '22rem', height: 'auto' }} onClick={Vendor}>
                    ...
                    <TD>
                      <div style={{ width: '15em' }}>
                        <Select
                          ...
                          onChange={e => {
                            DocLinesDropDownOnChange(e, item, 'ProjectCode')
                          }}
                    ...
                    <TD>
                      <div style={{ width: '15em' }}>
                        <Select
                          ...
                          onChange={e => {
                            DocLinesDropDownOnChange(e, item, 'CostingCode')
                          }}
            ...
            <Table responsive striped bordered hover>
              ...
              <tbody>
                {SelectedItems.map((item, index) => (
                  <tr key={`${index}`}>
                    <TD>{index + 1}</TD>
                    <TD>{ItemsDetails[item].Code||ItemsDetails[item].CardCode}</TD>
                    <TD>{ItemsDetails[item].Name||ItemsDetails[item].CardName}</TD>
                    <TD>{ItemsDetails[item].DebitorAccount ? ItemsDetails[item].DebitorAccount : null}</TD>
                    <TD>
                      <div style={{ width: '14rem', height: 'auto' }}>
                        <input
                          type='number'
