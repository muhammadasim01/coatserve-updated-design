...
import { General, Content, LinkedDocument } from "../../../Component/Activity";
  ...
  return (
    <>
      ...
      <div className="main_container">
        <div className="left">
          ...
          <div className="header_items_container">
            ...
            <Select
              ...
              // )}
              placeholder={
                SelectedPRDocEntry && SelectedPRDocEntry.ActivityType
                  ? HeaderData && HeaderData.ActivityType
                  : null
              }
          ...
          <div className="header_items_container">
            ...
            <Select
              ...
              // )}
              placeholder={
                SelectedPRDocEntry && SelectedPRDocEntry.Subject
                  ? HeaderData && HeaderData.Subject
                  : null
              }
          ...
          <div className="header_items_container">
            ...
            <input
              ...
              placeholder={
                SelectedPRDocEntry && SelectedPRDocEntry.BPLName
                  ? HeaderData && HeaderData.BPLName
                  : null
              }
            ></input>
          </div>
        ...
        <div className="right">
          <div className=" Activity header_items_container">
            <a
              onClick={(e) => {
            ...
            >
              {" "}
              <svg class="svg-icon20" viewBox="0 0 20 20">
          ...
          <div className="header_items_container">
            ...
            <Select
              ...
              // )}
              placeholder={
                SelectedPRDocEntry && SelectedPRDocEntry.CardName
                  ? HeaderData && HeaderData.CardName
                  : null
              }
          ...
          <div className="header_items_container">
            ...
            <input
              ...
              placeholder={
                SelectedPRDocEntry && SelectedPRDocEntry.Phone
          ...
          <div className="header_items_container">
            ...
            <Select
              ...
              // )}
              placeholder={
                SelectedPRDocEntry && SelectedPRDocEntry.ContactPersonCode
                  ? HeaderData && HeaderData.ContactPersonCode
                  : null
              }
              options={ContactPersonDropdown} // Options to display in the dropdown
